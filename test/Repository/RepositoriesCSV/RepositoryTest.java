...
class RepositoryTest {
    ...
    @AfterEach
    void cleanup(){
        Path path = Paths.get("C:\\Users\\Freja\\IdeaProjects\\InvesteringsKlubben\\test\\TestResources\\testUsers.csv");
        try(FileOutputStream out = new FileOutputStream("C:\\Users\\Freja\\IdeaProjects\\InvesteringsKlubben\\test\\TestResources\\testUsers.csv", false)){
